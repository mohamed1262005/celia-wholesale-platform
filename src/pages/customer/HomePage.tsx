  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden -z-10">
        <div className="absolute top-1/4 -start-32 w-96 h-96 bg-primary-200/40 rounded-full blur-3xl animate-pulse" />
        <div className="absolute top-2/3 -end-32 w-96 h-96 bg-pink-300/30 rounded-full blur-3xl animate-pulse" style={{ animationDuration: '6s' }} />
      </div>

      {/* Hero */}
      <section className="relative overflow-hidden bg-gradient-to-br from-primary-50/80 via-white to-secondary-50/80">
        <div className="absolute inset-0 opacity-30 pointer-events-none">
          <div className="absolute top-10 start-20 w-72 h-72 bg-primary-200 rounded-full blur-3xl" />
          <div className="absolute bottom-10 end-20 w-96 h-96 bg-secondary-200 rounded-full blur-3xl" />
        </div>
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-center lg:text-start space-y-6">
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-primary-100 text-primary-700 text-xs font-semibold animate-fade-in">
              ...
              {/* Trust badges */}
              <div className="grid grid-cols-3 gap-4 max-w-md mx-auto lg:mx-0 pt-4 border-t border-gray-100/80">
                {[
                  ...
                  <div key={i} className="flex flex-col items-center lg:items-start gap-1.5 text-center lg:text-start">
                    <div className="w-10 h-10 rounded-xl bg-white shadow-sm flex items-center justify-center text-primary-500 border border-gray-100">
      ...
      {/* Featured Categories */}
      <section className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 my-6 bg-gradient-to-r from-primary-50/40 via-pink-50/20 to-primary-50/40 rounded-3xl border border-pink-100/50 backdrop-blur-sm">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h2 className="text-2xl font-extrabold text-gray-900">{t('featuredCategories')}</h2>
        ...
        {catLoading ? (
          ...
          <div className="bg-white/80 backdrop-blur-md rounded-3xl border border-pink-100 shadow-card p-12 text-center space-y-4">
            <div className="w-16 h-16 rounded-3xl bg-primary-100 text-primary-600 flex items-center justify-center mx-auto animate-bounce">
              <FolderPlus className="w-8 h-8" />
            </div>
            <div>
              <h3 className="text-base font-extrabold text-gray-900">لا توجد تصنيفات مميزة مضافة حالياً</h3>
              <p className="text-xs text-gray-500 mt-1">ابدأ بإضافة تصنيفات جديدة لترتيب منتجاتك وعرضها للعملاء بكل احترافية</p>
            </div>
            {isAdmin && (
              <div className="pt-2">
                <Link to="/admin">
                  <button className="inline-flex items-center gap-2 px-6 py-3 bg-primary-500 hover:bg-primary-600 text-white rounded-2xl text-xs font-bold shadow-md transition-all cursor-pointer">
              ...
              return (
                ...
                >
                  ...
                  <div className="relative z-10 text-center">
                    <h3 className="text-white font-extrabold text-sm md:text-base drop-shadow-md">
                      {lang === 'ar' ? (cat.name_ar || cat.name) : (cat.name_en || cat.name)}
                    </h3>
                    <span className="text-[10px] text-pink-200 font-semibold opacity-0 group-hover:opacity-100 transition-opacity duration-300 inline-block mt-0.5">
                      تصفح المنتجات ✨
                    </span>
                  </div>
                </Link>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h2 className="text-2xl font-extrabold text-gray-900">{t('featuredProducts')}</h2>
            <p className="text-sm text-gray-500 mt-1">{t('shopByCategory')}</p>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-r from-primary-500 to-primary-700 p-8 lg:p-12 shadow-xl">
          ...
          <div className="relative flex flex-col lg:flex-row items-center justify-between gap-6">
            <div className="text-center lg:text-start">
              ...
              <p className="mt-2 text-primary-100 text-sm lg:text-base max-w-lg leading-relaxed">
                {lang === 'ar'
            ...
            <Link to="/products">
              <button className="px-8 py-4 bg-white text-primary-600 hover:bg-gray-50 rounded-2xl font-extrabold text-sm shadow-lg transition-all duration-300 hover:scale-105 active:scale-95 inline-flex items-center gap-2 cursor-pointer">
                <span>{t('shopNow')}</span>
                <ArrowRight className="w-4 h-4 rtl:rotate-180" />
              </button>
            </Link>
      ...
      {popularProducts.length > 0 && (
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-2xl font-extrabold text-gray-900">{t('popularProducts')}</h2>
            <Link to="/products" className="text-sm font-semibold text-primary-600 hover:text-primary-700 flex items-center gap-1">
              {t('viewAll')}
              <ArrowRight className="w-4 h-4 rtl:rotate-180" />
            </Link>
